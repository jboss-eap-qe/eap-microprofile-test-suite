...
public class MicroprofileConfigIntegrationTests {
    ...
    private final static String LOCAL_TO_SERVICE_PROVIDER_ROUTER_DEPLOYMENT_NAME = "localToServiceProviderRouterDeployment";
     ...
     * It contributes to the OpenAPI generation because {@code mp.openapi.scan.disable} is set to {@code false} by
     * default, and {@code mp.openapi.extensions.enabled} is set to {@code true} by default.
     *
     * @return {@link Archive} instance representing the Service Provider application
     */
    ...
    /**
     * OpenAPI doc here is configured via {@code mp.openapi.extensions.path} for the second deployment to have a
     * different path from the one defined by standard specs, and to provide a custom server record.
     * Here we also add config properties to reach the Services Provider
     *
     * @return {@link Archive} instance representing the Local Service Router application
    ...
    @Deployment(name = LOCAL_TO_SERVICE_PROVIDER_ROUTER_DEPLOYMENT_NAME, order = 3, testable = false)
    public static Archive<?> localToServiceProviderRouterDeployment()
            throws ConfigurationException, IOException, ManagementClientRelatedException {
        ...
        //  OpenAPI doc here is generated by the third deployment, which provides a custom server record.
        //  Here we also add config properties to reach the Services Provider
        String mpConfigProperties = "mp.openapi.scan.disable=false"
                + "\n" +
                "mp.openapi.servers=https://xyz.io/v1"
        ...
        return ShrinkWrap.create(
                WebArchive.class, LOCAL_TO_SERVICE_PROVIDER_ROUTER_DEPLOYMENT_NAME + ".war")
                .addClasses(
                        RouterApplication.class,
                        LocalServiceRouterInfoResource.class,
                        DistrictObject.class,
    ...
    /**
     * @tpTestDetails Integration test to verify that the {@code title} property is discordant since it is
     *                sourced from the deployment name in the
     *                {@link MicroprofileConfigIntegrationTests#PROVIDER_DEPLOYMENT_NAME} and
     *                {@link MicroprofileConfigIntegrationTests#LOCAL_TO_SERVICE_PROVIDER_ROUTER_DEPLOYMENT_NAME}, while it
     *                defaults to {@code Generated API} for
     *                {@link MicroprofileConfigIntegrationTests#SCAN_DISABLING_ROUTER_DEPLOYMENT_NAME}.
     * @tpPassCrit The server is logging expected {@code WFLYMPOAI0009} message.
     * @tpSince EAP 7.4.0.CD19
     */
    @Test
    public void testWarningIsLoggedBecauseOfDiscordantTitleProperty()
     ...
     *             deployment related OpenAPI document is generated properly despite
     *             {@code mp.openapi.scan.disable=true} is defined by
     *             {@link MicroprofileConfigIntegrationTests#LOCAL_TO_SERVICE_PROVIDER_ROUTER_DEPLOYMENT_NAME}
     *             and a custom server record is found as added by
     *             {@link MicroprofileConfigIntegrationTests#LOCAL_TO_SERVICE_PROVIDER_ROUTER_DEPLOYMENT_NAME}
     * @tpSince EAP 7.4.0.CD19
     */
    @Test
    ...
    public void testDisabledAnnotationsScanIsNotAffectingPreviousDeploymentServerRecords(
        ...
        Assert.assertEquals("\"url\" property value was not found",
                firstServerRecord.get("url"), "https://xyz.io/v1");
    }
}
